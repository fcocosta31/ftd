...
public class ItemPedCliente implements Comparable<Object>, Serializable{
	...
	private int pendenciatotal;
	private int mediapendente;
	private int maiorpendencia;
	...
	public int getPendenciatotal() {
		return pendenciatotal;
	}

	public void setPendenciatotal(int pendenciatotal) {
		this.pendenciatotal = pendenciatotal;
	}

	public int getMediapendente() {
		return mediapendente;
	}

	public void setMediapendente(int mediapendente) {
		this.mediapendente = mediapendente;
	}

	public int getMaiorpendencia() {
		return maiorpendencia;
	}

	public void setMaiorpendencia(int maiorpendencia) {
		this.maiorpendencia = maiorpendencia;
	}
}
