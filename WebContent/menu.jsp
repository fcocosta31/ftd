...
<div class="nav-wrapper">
			...
			<a href="index.jsp" class="brand-logo" title="Página inicial"><img 
				src="resources/images/logofenovo_white.png" width="95" height="auto"></a>
...
<div id="modaluserlogin" class="modal">
  ...
  <div class="modal-content watermark-over">  
    <div class="row">
    	   ...
    	   <div class="row">
	    	   	<form action="srl" id="formuserlogin" method="post" class="navbar-form" role="form">
			 		...
			 		<div class="input-field">
			 			...
			 			<input type="text" name="txtlogin" id="txtlogin" autocomplete="off" required class="validate">
			 			<label for="txtlogin" class="active">Login</label>
			 		</div>
			 		<div class="input-field">
			 			<i class="material-icons prefix blue-text">lock</i>
			 			<input type="password" name="txtsenha" id="txtsenha" autocomplete="off" required class="validate">
			 			<label for="txtsenha" class="active">Senha</label>
			 		</div>
			 		<input type="hidden" name="acao" value="logon">
					<div class="input-group">
						<div>
							  <button class="btn waves-effect waves-light blue" type="button" id="btnUserLogin">
							  	Enviar
							  </button>
						</div>
						<div>
							<input type="radio" class="with-gap blue" id="radio1" name="usertype" value="usuario" checked>
							<label for="radio1">Usuário</label>
							<input type="radio" class="with-gap blue" id="radio2" name="usertype" value="livreiro">
...
<ul>
	...
	<li>
				...
				<a href="pedClienteNaoAtendidosListar.jsp" >Itens não atendidos sem pendência (xls)</a>
	...
	<div class="nav-wrapper row">
		...
		<div class="col l5 m2 s1 divnavbutton">
			<c:if test="${!empty usuariologado and usuariologado.cargo != 4}">			
				...
				<img alt="Menu" src="resources/images/icons8-menu-64.png" class="waves-effect waves-light"></a>
			</c:if>
		</div>		
				...
				<!-- carrinho de livros -->
					<div id="imgCart2">
						<a href="orcamentoImprimir.jsp" title="Detalhar orçamento">
							<img src="resources/images/icons8-shopping-cart-64.png">
							<c:choose>
