...
jQuery.validator.addMethod("ean13", function(value, element){
	...
	if( value.length == 13 ){ // verifica se h� 13 d�gitos
	var dv = value.substr( -1 ); // isola o d�gito verificador original
	var ean = value.substr( 0, (value.length - 1) ); // retira o d�gito verificador do c�digo
	} else if( value.length != 12 ){ // verifica se c�digo possui 12 d�gitos
	// C�digo inv�lido
	return false;
	}

	// Soma os n�meros de posi��es pares
	...
	// Soma os n�meros de posi��es �mpares
	...
	// Divide o produto total por 10 e armazena o resto da divis�o
	var digito = total % 10;

	// Se o resto n�o for zero retira este resto de 10
	if( digito != 0 ){
	digito = 10 - digito;
	}

	// Se o d�gito calculado for diferente do informado
	// o c�digo � inv�lido
	if ( dv != digito )	return false;
	return true;

	}, "Código EAN13 inválido"); // Mensagem padr�o
