...
;(function ($) {
  $(document).ready(function () {
    ...
    ****************/
    ...
    $.fn.autocomplete = function (options) {
      ...
      //enviar formulario no caso da tecla enter
      $(this).off('#autocomplete-input').on('keydown', function(e){
      	if(e.which == 13){
      		
      		e.preventDefault();

      		formulario = $('#formsearchitem').serialize();
      ...
      return this.each(function () {
        ...
        if (!$.isEmptyObject(data)) {
          ...
          $input.off('keyup.autocomplete focus.autocomplete').on('keyup.autocomplete focus.autocomplete', function (e) {
            ...
            // Don't capture enter arrow key usage.
  ...
  $.fn.material_select = function (callback) {
    ...
    //NEW FUNCTION SEARCH ADDED IN MATERIAL_SELECT BY CHICOH
    //Added to search
    ...
    //END OF NEW FUNCTION ADDED BY CHICOH      
