...
<div class="nav-wrapper">
			...
			<a href="index.jsp" class="brand-logo" title="Página inicial"><img 
				src="<c:url value="/resources/images/logofe_white.png" />" width="95" height="auto"></a>

	<ul class="right">			
			<!-- CARRINHO PEDIDO CLIENTES -->
			<li id="totalroteiro">
				<c:if test="${!empty pedcliente}">					
					<a href="pedClienteRegistrar.jsp" title="Detalhar"><img alt="Detalhar" src="<c:url value="/resources/images/information.png" />"></a>
    	   ...
    	   <div class="row">
	    	   	<form action="srl" id="formuserlogin" method="post" class="navbar-form" role="form">
			 		...
			 		<div class="input-field">
			 			...
			 			<input type="text" name="txtlogin" id="txtlogin" autocomplete="off">
			 		</div>
			 		<div class="input-field">
			 			<i class="material-icons prefix">lock</i>
			 			<input type="password" name="txtsenha" id="txtsenha" autocomplete="off">
			 		</div>
			 		<input type="hidden" name="acao" value="logon">
					<div class="input-group">
						<div>
							  <button class="btn waves-effect waves-light grey loadevent" type="button" id="btnUserLogin">
							  	Enviar
							  </button>
						</div>
						<div>
...
<li><div class="user-view">
  <div class="background">
    <img src="<c:url value="/resources/images/modern-dark-texture-background.jpg" />" width="auto" height="200px">
  </div>
  <article>
  <h5>${pageTitle}</h5>
...
<li>
		...
		<a href="javascript:void(0)"
			onclick="menuadminclick('systemparams', ${usuariologado.cargo})">System Params</a>
</li>
</ul>
</div>
</li>			
	...
	<div class="nav-wrapper row">
		...
		<div class="col l5 m2 s1 divnavbutton">
			<c:if test="${!empty usuariologado and usuariologado.cargo != 4}">			
				...
				<img alt="Menu" src="<c:url value="/resources/images/menu_icon_black.png" />" class="waves-effect waves-light"></a>
			</c:if>
		</div>		
				...
				<!-- carrinho de livros -->
					<div id="imgCart2">
						<a href="orcamentoImprimir.jsp" title="Detalhar orçamento">
							<img src="<c:url value="/resources/images/shopping-cart-icon.png" />">
							<c:choose>
